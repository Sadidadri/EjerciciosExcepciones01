...
Version ampliada del gatoSimple para el ejercicio 2
@author: d18momoa
'''
from ejerciciosExcepciones.apareamientoError import apareamientoError
class GatoSimple2:
    #Constructor
    ...
    def apareaCon(self,pareja):
        if(self.s == pareja.s):
            ...
            print("Los gatetes tienen una cita apasionada...")
